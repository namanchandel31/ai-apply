          ...
          <div className="m-problem-outer">
            <div className="m-problem-content">
              <SplitHeading
                ...
                primary="It's everything around it."
              />

              <p data-reveal="" className="m-problem-lead m-body-text">
                Every job application comes with its own set of repetitive tasks: reading job
                descriptions, figuring out whether you&apos;re a good fit, tailoring your outreach,
                switching between AI tools to write emails, and keeping track of what you&apos;ve
                already done.
              </p>
              ...
              <div className="m-problem-texts">
                <p data-reveal="" className="m-problem-p m-body-text">
                  ...
                  more copy-pasting, and more effort spent managing the process instead of focusing
                  on the opportunities themselves.
                </p>
                <p data-reveal="" className="m-problem-p m-problem-closing m-body-text">
                  <span className="m-problem-closing-marker">
                    One Tap brings personalized email generation, sending, and tracking job applications into a single
                    workflow.
                  </span>
                </p>
              </div>
