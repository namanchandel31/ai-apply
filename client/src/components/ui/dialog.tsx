...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 flex w-[calc(100%-2rem)] max-w-4xl -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-[12px] bg-card p-6 shadow-[var(--shadow-modal)] outline-none data-[state=open]:animate-sheet-fade-in data-[state=closed]:animate-sheet-fade-out max-h-[min(90vh,900px)] overflow-y-auto",
        className
      )}
      {...props}
    >
